...
\033[1;36m=================================================
 \033[1;36m[1] First NOTE:
 \033[1;36m[2] AIRPLANE MODE ON OFF
 \033[1;36m[3] THIS TOOL IS PAID NOT FREE OK
 \033[1;36m[4] You Unstall Termux And Key Need Approval
================================================== 
 [*] File Cloning
 [*] Create File
 [*] Public Cloning
...
def tnx():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "_".join(uuid)
  server = requests.get('https://github.com/meerkb007/Test/blob/main/T.txt').text
  ...
  print("\x1b[1;32m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/meerkb007/Test/blob/main/T.txt").text
    if id in httpCaht:
      print("\033[1;32m   YOUR TOKEN APROVED Ã°Å¸Â¥â‚¬ ");time.sleep(2)
      msg = str(os.geteuid())
      time.sleep(0.5)
